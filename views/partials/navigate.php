        ...
        <h4 class="text-center fw-bold">
            <div class="text-start">
                ...
                <div class="text-center mt-2">
                    <a href="#" id="goButton"><button class="btn btn-sm btn-primary" disabled>Go</button></a>
                </div>
      ...
      $(document).ready(function() {
        ...
        $('#adhyaya').change(function() {
            ...
            if (adhyayaId) {
                ...
                $('#goButton button').prop('disabled', true);
                $('#goButton').attr('href', '#');
            }
        });
        ...
        $('#shloka').change(function() {
            ...
            if (shlokaId) {
                ...
                $('#goButton').attr('href', newUrl);
                $('#goButton button').prop('disabled', false);
            } else {
                $('#goButton button').prop('disabled', true);
                $('#goButton').attr('href', '#');
            }
