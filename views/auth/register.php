...
<body class="text-center">
  ...
  <div class="logo mt-5 pt-5">
    <a href="<?php echo home() ?>"><img src="<?php echo home() . $config['APP_LOGO']; ?>" alt="GraphenePHP"
        class="img-fluid"></a>
  </div>
  <form method="POST" name="Register" class="form-signin">
    <h2 class="mb-3 fw-bolder">User Registration </h1>
      ...
      <div class="text-end">
        <span class="text-smruthi user-select-none" id="eye"></span>
      </div>
      <div class="mb-3">
      ...
      <button class="btn btn-lg btn-smruthi btn-block" id="btn-register" name="btn-register" type="register"
